...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        driver.get("http://localhost:6080/MedicalStoreProject");
        ...
        pass.sendKeys("1234");
        button.click();
        assertTrue(driver.getPageSource().contains("Medical Store"));
	}
	
	//@Test
	public void loginFail() {
        driver.get("http://localhost:6080/MedicalStoreILP");
        WebElement email = driver.findElement(By.name("email"));
        WebElement pass = driver.findElement(By.name("password"));
        WebElement button = driver.findElement(By.xpath("/html/body/form/div/button"));         
        email.sendKeys("avinash.patel@wipro.com");
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/MedicalStoreProject/register.jsp");
	...
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/MedicalStoreProject/forgotpassword.jsp");      
